...
public class PlaylistSQL implements PlaylistDAO {
     ...
     */
    @Override
    public Playlist getPlaylistByID(int playlistID, UserDAO userDAO, SongDAO songDAO) throws SQLException {
        Connection c = DBConfig.getInstance().openConnection();
     ...
     */
    @Override
    public ArrayList<Playlist> getAllPlaylists(UserDAO userDAO, SongDAO songDAO) throws SQLException{
        Connection c = DBConfig.getInstance().openConnection();
     ...
     */
    @Override
    public ArrayList<Playlist> getPlaylistsByTitle(String title, UserDAO userDAO, SongDAO songDAO) throws SQLException{
        Connection c = DBConfig.getInstance().openConnection();
        ArrayList<Playlist> playlists = new ArrayList<>();
